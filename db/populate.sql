...
insert into MOVIES values (1, 'Le Seigneur des anneaux', 'Peter', 'Jackson');
insert into MOVIES values (2, 'Harry Potter', 'Chris', 'Columbus');
...
insert into USERS values (1, 'Francois', 'Lefrancais', 'Rue de la France', 1);
insert into USERS values (2, 'Gerard', 'Lebreton', 'Rue de Bretagne', 0);
...
insert into SUPPORTS values (1, 'BluRay', 1, 0, NULL, 1);
insert into SUPPORTS values (2, 'QRCode', NULL, NULL, 'https://www.cybervideo.com/le-seigneur-des-anneaux', 1);
insert into SUPPORTS values (3, 'BluRay', 0, 0, NULL, 2);
insert into SUPPORTS values (4, 'QRCode', NULL, NULL,'https://www.cybervideo.com/harry-potter', 2);
